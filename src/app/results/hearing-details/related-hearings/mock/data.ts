import { AvailableHearing, CourtCentre } from '../../../../core';

export const courtCentresMock: CourtCentre[] = [
  {
    ...
    courtrooms: [
      {
        ...
        name: 'Courtroom 3-1',
        welshCourtroomName: 'Welsh Courtroom 3-1'
      },
      {
        id: '63c20849-89f7-4140-8bf3-96a13f57c446',
        name: 'Courtroom 3-2',
        welshCourtroomName: 'Welsh Courtroom 3-2'
      }
    ]
  }
];

export const validAvailableHearingMock1: AvailableHearing = {
  ...
  hearingDays: [
    {
      ...
      endTime: '2018-10-05 12:00:00',
      sequence: 1,
      startTime: '2018-10-05 10:00:00',
      durationMinutes: 120
    },
    {
      hearingDate: '2018-10-06',
      endTime: '2018-10-06 14:00:00',
      sequence: 2,
      startTime: '2018-10-06 11:00:00',
      durationMinutes: 180
    }
  ],
  ...
  nonDefaultDays: [
    {
      duration: 180,
      startTime: '2018-10-05T11:00:00.000Z'
    }
  ],
  nonSittingDays: ['2018-10-06', '2018-10-07'],
