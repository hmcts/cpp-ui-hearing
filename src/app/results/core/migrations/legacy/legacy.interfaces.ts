...
export namespace Legacy {
  export interface DraftResult {
    targets: DraftResultTarget[];
  }

  export interface DraftResultLine {
    ...
    originalText: string;
    resultCode: string;
    resultLevel: V1.ResultDefinitionLevel;
    parts: DraftResultLinePart[];
    ...
    dirty?: boolean;
    ruleType?: V1.ChildResultDefinition['ruleType'];
    orderedDate: string;
    childResultDefinitions: V1.ChildResultDefinition[];
    childResultLines?: DraftResultLine[];
    atLeastOneOfChildrenNumber?: number;
    shouldHaveAtLeastOneChild?: boolean;
    conditionalMandatory: boolean;
    conditionalMandatorySelection: 'YES' | 'NO';
    delegatedPowers?: {
      userId: string;
      firstName: string;
      lastName: string;
  ...
  export interface DraftResultLinePart {
    value: string | PromptChoice[];
    originalText?: string;
    resultChoices?: V1.RemoteResultChoice[];
    type: V1.ResultPromptType | 'RESULT';
    state: 'UNRESOLVED' | 'RESOLVED';
    promptRef?: string;
  }

  export interface DraftResultTarget {
  ...
  export interface ReusableInfo {
    reusablePrompts: V1.PromptEntry[];
